...
import { getPageImgData } from '../components/PageRenderer.js';

export class Lightbox {
  static currentIdx = null;
  static touchX = 0;
  static releaseFocus = null;
  static prevFocus = null;
  ...
  static init() {
    ...
    if (lb) {
      lb.addEventListener('click', (e) => {
        if (e.target === lb || e.target.classList.contains('lb-bg')) this.close();
      });
